...
1. create `server.properties` & set `level-name` to your world name
...
2. mount your world path to `/mc/worlds/<name>` & mount server.properties to `/mc/server.properties`

Demo

```bash
docker run --name mc -d -p 19132:19132/udp -v /home/ubuntu/worlds/fry:/mc/worlds/fry -v /home/ubuntu/server.properties:/mc/server.properties kainhuck/bedrock_server:1.18.12.01
```
